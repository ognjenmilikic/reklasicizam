...
<div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select id="sort" class="form-control" onchange="loadProducts('Ž')">
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <select id="autori" class="form-control" onchange="loadProducts('Ž')">
    ...
    <div class="row section-1">
        <div class="col-md-12" id="products-section"></div>
    </div>
